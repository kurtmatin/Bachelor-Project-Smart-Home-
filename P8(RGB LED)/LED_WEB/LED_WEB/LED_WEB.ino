...
#include "index_js.h" 
  // موقع برنامه نویسی با آردوینو باید حواسمان به این باشد که ورژن کتابخانه با ورژن منیجر ماژولی که با آن کار می کنیم، مطابقت داشته باشد.//
int PIN = 14  ;// Pin D7 = 14
int NUM_LEDS =  6  ;
String RED  ;
String GREEN ;
String BLUE ;
